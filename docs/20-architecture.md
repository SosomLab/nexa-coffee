...
│ app.c     상태(CfApp) · 메뉴 트리(id 고정) · 클릭→행동 · 설정 텍스트 · 툴팁 · en/ko/ja/zh │
└──────────────────────────────────────────────────────────────────────────────┘
...
## 4. 메뉴 id(3-OS 공통)
`14 남은 시간(비활성) · 15 ─ · 1 ∞ · 2 12h · 3 6h · 4 2h · 5 1h · 6 30m · 7 사용자 지정… · 8 끄기 · 9 ─ · 10 자동 시작▸ · 16 언어▸ · 11 ─ · 12 정보… · 13 종료`
...
`20 자동 시작▸끄기 · 21 자동 시작▸사용자 지정…` · `30 English · 31 한국어 · 32 日本語 · 33 中文`(언어▸ · 클릭 = `CF_ACT_LANG` → 저장 + 메뉴·툴팁 갱신)
