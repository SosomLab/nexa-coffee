...
| T-2 | P0 | 중 | Windows 실기 — 트레이 아이콘 DPI(100/150/200%) · 메뉴 라디오/체크 · `powercfg /requests`로 억제 확인 · TaskbarCreated | ☐ |
...
| T-11 | P0 | 소 | i18n Windows·macOS 빌드/실기 확인 — 09-13 언어 메뉴는 Linux PC에서 구현해 두 OS는 CI 빌드만. 메뉴 CJK 글꼴 · 입력 창 라벨 폭(일본어 "キャンセル"·중국어) · Windows `LANG_CHINESE` 번체/간체 구분 없음(간체 문구만) | ☐ |
